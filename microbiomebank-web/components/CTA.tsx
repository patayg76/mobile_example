  ...
  return (
    <section id="contact" className="scroll-mt-20 px-5 py-20 sm:px-8">
      <Reveal className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-deep px-6 py-16 text-center text-white sm:px-12 sm:py-20">
        <div className="anim-gradient absolute inset-0 -z-10 opacity-90 [background:radial-gradient(50%_60%_at_20%_20%,rgba(154,211,166,0.28),transparent),radial-gradient(50%_60%_at_80%_30%,rgba(108,187,124,0.26),transparent),linear-gradient(180deg,#1f5130,#0e2f1a)]" />
